...
namespace Chapter_6_4_bee_hive
{
    public partial class Form1 : Form
    {
        ...
        private void jobAssignButton_Click(object sender, EventArgs e)
        {
            if(queen.AssignWork(workerBeeJob.Text,(int)shiftsUpDown.Value)==false)
            {
                MessageBox.Show("No workers are available to do the job '" + workerBeeJob.Text + "'", "The queen bee says...");
            }
            else
            {
                MessageBox.Show("The job '" + workerBeeJob.Text + "' will be done in " + shiftsUpDown.Value + " shifts", "The queen bee says...");
            }
